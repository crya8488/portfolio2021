...
$title = '特約分享｜大肚山地方知識平台';
$description = '特約分享｜大肚山地方知識平台';
...
<div class="list-page inner-page" data-bgcolor="orange">
 ...
 <main class="main w1440">
  <div class="title-box" data-color="orange">
   <img src="img/title/share.png" alt="特約分享">
  </div>
  ...
  <ul class="box-list" data-color="orange">
   <li>
    <a href="share_d.php" class="content">
     <div class="pic" style="background-image:url('img/demo/photo2.jpg')"></div>
     <div class="tag">
      <p>2020-12-31</p>
    ...
    <a href="share_d.php" class="btn">閱讀更多<i class="icon-search"></i></a>
   </li>
   <li>
    <a href="share_d.php" class="content">
     <div class="pic" style="background-image:url('img/demo/photo2.jpg')"></div>
