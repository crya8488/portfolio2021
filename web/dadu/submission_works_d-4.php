...
$title = '投稿作品標題(圖片+文章投稿)｜大肚山知識平台';
$description = '投稿作品標題(圖片+文章投稿)｜大肚山知識平台';
  ...
  <section id="article-wrap">
   ...
   <div class="info-box">
    ...
    <ul class="breadcrumb">
     ...
     <li><a href="submission_d.php">大肚山徵文+徵圖活動</a></li> <!-- 投稿活動頁面 -->
    </ul>
   </div>
    ...
    <!-- 【投稿圖片區】  
     ...
     <div id="submit-photo">
      ...
      <!-- 相片輪播 -->
       ...
       <div class="submit-gallery-s" id="gallery">
        <a href="img/demo/photo1.jpg"><img src="img/demo/photo1.jpg" alt="文章標題"></a>
        <a href="img/demo/photo2.jpg"><img src="img/demo/photo2.jpg" alt="文章標題"></a>
        <a href="img/demo/photo3.jpg"><img src="img/demo/photo3.jpg" alt="文章標題"></a>
        <a href="img/demo/photo4.jpg"><img src="img/demo/photo4.jpg" alt="文章標題"></a>
        <a href="img/demo/photo5.jpg"><img src="img/demo/photo5.jpg" alt="文章標題"></a>
       </div>
