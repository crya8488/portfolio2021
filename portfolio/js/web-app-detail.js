$(function(){
    var projectType = 'App UI';
    var projectTypeName = '應用程式介面設計';
    var projectListPage = 'project-app.html';
    ...
    $('#top-nav').find('ul').append(`
        ...
        <li>
            <a href="#detail-wrap">Details</a>
        </li>
        <li class="back">
            <a href="#moreproject">More</a>
        </li>
        <li class="back">
            <a href="${projectListPageLink}">Back</a>
        </li>
        ...
        for  ( var i = 0 ; i < data.length ; i++ ){
            ...
            if( page == thisProject ){
                    ...
                    $('#project-page').each(function(){
                        ...
                        $(detail).prepend(`
                            <p>${data[i].info[0].intro}</p>
                        `);

                        var detailImg = data[i].detailImg;
                        ...
                        var link = data[i].info[0].url;

                        if( link !== ""){
                            $(detail).append(`
                                <div class="btn-block">
                                    <a href="${link}" target="_blank" class="btn-primary btn-lg">開啟 Figma<i class="bi bi-arrow-right-circle-fill"></i></a>
                                </div>
                            `);
