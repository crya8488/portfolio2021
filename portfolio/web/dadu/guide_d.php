...
$title = '在地嚮導文章標題｜大肚山知識平台';
$description = '在地嚮導文章標題｜大肚山知識平台';
$keywords = '在地嚮導文章標題,在地嚮導,大肚山知識平台';
...
<div class="article-page inner-page" data-bgcolor="orange">
 ...
 <main class="main w1200">
  ...
  <section id="article-wrap">
   ...
   <div class="info-box pc">
    ...
    <ul class="breadcrumb">
     ...
     <li><a href="history.php">在地嚮導</a></li> <!-- 大分類 -->
     <li><a href="history.php">在地職人</a></li> <!-- 小分類 -->
    </ul>
   </div>
   ...
   <article>
    ...
    <div class="article-box">
     <img src="img/demo/guide_d_3.jpg" alt=""   style="width:100%;"><br>
     <p>
      圖文內容編輯區<br>
      您可以在此自由編輯文字內容與樣式<br>
   ...
   <div class="more-wrap">   
    <!-- 看更多(相關連結功能) -->
    <div class="more-box link" data-color="brown">
     <h5>看更多<i class="icon-arrow-down"></i></h5>
     <div class="content">
      <ul class="box-list">
       <li>
        <a href="#">
         <img src="img/tag-go2.svg" alt="前往" class="mark">
         <div class="pic" style="background-image:url('img/demo/guide_link1.jpg')"></div>
         <p>店家網站</p>
        </a>
       </li>
       <li>
        <a href="#">
         <img src="img/tag-go2.svg" alt="前往" class="mark">
         <div class="pic" style="background-image:url('img/demo/guide_link2.jpg')"></div>
         <p>Facebook粉絲專頁</p>
        </a>
       </li>
       <li>
        <a href="#">
         <img src="img/tag-go2.svg" alt="前往" class="mark">
         <div class="pic" style="background-image:url('img/demo/guide_link3.jpg')"></div>
         <p>線上商店</p>
        </a>
       </li>
       <li>
        <a href="#">
         <img src="img/tag-go2.svg" alt="前往" class="mark">
         <div class="pic" style="background-image:url('img/demo/guide_link4.jpg')"></div>
         <p>Google地圖</p>
        </a>
       </li>
  ...
  <section id="article-more">
   ...
   <!-- 文章列表 -->
   <ul class="box-list" id="related-article" data-color="orange">
    <li>
     <a href="#" class="content">
      ...
      <div class="text">
       <h5>大肚山歷史之行‧旅遊記趣</h5>
       <h6>文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要文章內文摘要...</h6>
      </div>
     </a>
   ...
   <div class="page-link-box">
    <a href="guide_d.php"><i class="icon-arrow-left"></i><p>下一篇文章標題</p></a>
    
    <a href="guide.php" class="back"><p>返回列表</p></a>

    <a href="guide_d.php"><p>下一篇文章標題</p><i class="icon-arrow-right"></i></a>
   </div>
